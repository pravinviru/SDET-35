...
public class PurchaseOrderInformationwithStatus {
                      ...
                      String product = exceldriver.getDataFromExcel("sheet1", 1, 1);
                       ...
                       vebdriver.waitforelementInDOM(driver);
                         ...
                         String item = exceldriver.getDataFromExcel("sheet1", 4, 1);
                          ...
                          driver.findElement(By.xpath("//a[text()='PurchaseOrder Status History']")).click();
                          
                    //  String ptext = driver.findElement(By.xpath("(//div[@style='font-weight: bold;height: 1.75em;'])[4]")).getText();
                         
                //   String stext = driver.findElement(By.xpath("//td[text()='PurchaseOrder Status' and @class='lvtCol']")).getText();
